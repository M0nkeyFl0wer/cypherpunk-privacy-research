  ...
  return (
    <div className="min-h-screen bg-brand-bg-dark">
      <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="mb-8 p-6 bg-green-500/10 border border-green-500/30 rounded-lg">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-green-300/90 mb-3">
        ...
        {/* Instructions */}
        <div className="mb-10 p-8 bg-brand-bg-darker border border-brand-bg-active rounded-lg">
          ...
          <div className="space-y-6">
            {/* Missing Project */}
            <div>
              <h3 className="text-lg font-semibold text-brand-accent-purple mb-2 flex items-center gap-2">
              ...
              <div className="pl-4 border-l-2 border-brand-bg-active">
          ...
          <div className="mt-6 p-4 bg-brand-bg-dark rounded border border-brand-bg-active">
            <p className="text-sm text-brand-text-muted">
              <strong className="text-brand-text-secondary">Note:</strong> All feedback is publicly visible as GitHub issues. Please don't include sensitive information. Submissions are automatically tagged with{' '}
              <code className="px-1.5 py-0.5 bg-brand-bg-active text-brand-accent-purple rounded text-xs">@M0nkeyFl0wer</code>
              {' '}for review.
            </p>
          </div>
        </div>
        ...
        {/* Additional Links */}
        <div className="mt-10 pt-8 border-t border-brand-bg-active">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-4 bg-brand-bg-darker border border-brand-bg-active rounded-lg hover:border-brand-accent-purple transition-colors group"
            >
              <div className="flex items-center gap-3 mb-2">
                <svg className="w-6 h-6 text-brand-accent-purple" fill="currentColor" viewBox="0 0 24 24">
