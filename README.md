...
**Live Site:** [cypherpunk-research.monkeyflower.ca](https://cypherpunk-research.monkeyflower.ca)
...
In Oct 2025, we submitted PR #1997 to web3privacy/explorer-data. The PR accidentally overwrote existing high-quality data with template placeholders. A Zcash community developer caught it and helped us roll it back.
